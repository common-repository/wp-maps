 ...
 * Wpmaps_Requirements: only required the declaration, check the minimum value inserted, call directly the warning
 * Plugin_requirements: support multiple plugin
 * Requirement_Error: compacted code, better css, added deactivation of the plugin
 */

if ( class_exists( 'Wpmaps_Requirements' ) === false ) {
    ...
    class Wpmaps_Requirements {
         ...
         * 
         * @param    string    $pluginname The Wp Maps used for the warning
    ...
    /**
     * Check the PHP environment, for example go to Wpmaps_Requirements documentation
     *
     * @package WpMaps_Display
     * @author  Mte90 and dsawardekar
     */
    ...
    /**
     * Check the Wordpress environment, for example go to Wpmaps_Requirements documentation
     *
     * @package WpMaps_Display
     * @author  Mte90 and dsawardekar
     */
    ...
    /**
     * Check the PHP extension, for example go to Wpmaps_Requirements documentation
     *
     * @package WpMaps_Display
     * @author  Mte90 and dsawardekar
     */
    ...
    /**
     * Check the plugin required, for example go to Wpmaps_Requirements documentation
     *
     * @package WpMaps_Display
     * @author  Mte90 and dsawardekar
     */
     ...
     * @author  Mte90 and dsawardekar
     */
    class Wpmaps_Requirements_Exception extends \Exception {
    ...
    class Requirement_Error {
        ...
        function showError( $message ) {
            if ( $this->isErrorScraper() ) {
                ...
                throw new Wpmaps_Requirements_Exception();
            }
        }
